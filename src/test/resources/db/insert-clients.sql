...
VALUES ('Иван', 'Иванович', 'Иванов', '1970.01.01', '+79231233445', 'Малярия', 'ivanoff@ya.ru', null, null),
       ('Пётр', 'Петрович', 'Петров', '1978.01.01', '+79231233446', 'Корь', 'petrov@ya.ru', null, null),
       ('Сергей', 'Иванович', 'Сергеев', '1990.01.01', '+79231233447', 'Краснуха', 'sergeev@ya.ru', null, null);
